...
class Lab2_SDR_Osciloscopio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab2_ConfiguracionUSRPZ", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab2_ConfiguracionUSRPZ")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab2_SDR_Osciloscopio")
...
def main(top_block_cls=Lab2_SDR_Osciloscopio, options=None):
