...
class punto_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Amplitud_range = Range(0, 100, 1, 50, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, Amplitud, 0, 0)
        self._Frecuencia_range = Range(0, 100, 1, 50, 200)
