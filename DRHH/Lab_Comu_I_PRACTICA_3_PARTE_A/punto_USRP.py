...
class punto_USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "punto_USRP")
        ...
        self._fm_range = Range(0, 1e4, 100, 1000, 200)
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecuencia señal", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, fm, A, 0, 0)
...
def main(top_block_cls=punto_USRP, options=None):
