...
from Envolvente_compleja_SSB import Envolvente_compleja_SSB  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._K_win = RangeWidget(self._K_range, self.set_K, "camnbio de banda", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._B_range = Range(0, 1, 1, 1, 200)
        self._B_win = RangeWidget(self._B_range, self.set_B, "habilita portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._B_win)
        self._Ac_range = Range(0, 1, 0.01, 0.25, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/edacecar_bbc_trenes (2).wav', True)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.Envolvente_compleja_SSB_0 = Envolvente_compleja_SSB(
            Ac=Ac,
            B=B,
            K=K,
        )
        ...
        self._Am_range = Range(0, 1, 0.01, 0.25, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_compleja_SSB_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.Envolvente_compleja_SSB_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Envolvente_compleja_SSB_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Envolvente_compleja_SSB_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.CalculoPotenciacomunicaciones_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.Envolvente_compleja_SSB_0, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.Envolvente_compleja_SSB_0.set_K(self.K)
    ...
    def set_B(self, B):
        self.B = B
        self.Envolvente_compleja_SSB_0.set_B(self.B)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Envolvente_compleja_SSB_0.set_Ac(self.Ac)
