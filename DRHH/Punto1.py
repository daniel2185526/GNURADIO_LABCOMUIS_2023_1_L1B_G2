...
# Title: Lab1_Punto1
# Author: Lab1_Daniel_Rojas_Yonatan_Hernandez_L1B_G2
...
class Punto1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_Punto1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_Punto1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Punto1")
...
def main(top_block_cls=Punto1, options=None):
