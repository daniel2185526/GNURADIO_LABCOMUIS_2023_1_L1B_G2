...
# Title: lab_cumu
# Author: Daniel_Rojas_Felipe_Hernandez
...
class Lab_punto5b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "lab_cumu", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab_cumu")
        ...
        self._f_corte_win = RangeWidget(self._f_corte_range, self.set_f_corte, "freciencia corte", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._f_corte_win)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/labachata_manuelturizo.wav', True)
